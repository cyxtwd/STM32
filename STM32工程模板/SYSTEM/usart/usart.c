...
//=================================================================================================
//【名       称】 加入以下代码,支持printf函数,而不需要选择use MicroLIB
//【参       数】 
//【功       能】 None
//【返   回  值】 None
//=================================================================================================	
...
{ 	
	while((D_Printf_Use_USARTx->SR&0X40)==0);//循环发送,直到发送完毕 
	D_Printf_Use_USARTx->DR = (u8) ch;      
	return ch;
}

//=================================================================================================
//【名       称】 USART1_Init(u32 bound)
//【参       数】 bound（波特率）
//【功       能】 初始化串口1
//【返   回  值】 None
//=================================================================================================		
...
//=================================================================================================
//【名       称】 USART1_Send(unsigned char *DataToSend ,u8 data_num)
//【参       数】 
//【功       能】 串口1发送数据
//【返   回  值】 None
//=================================================================================================	
...
//=================================================================================================
//【名       称】 USART2_Send(unsigned char *DataToSend ,u8 data_num)
//【参       数】 
//【功       能】 串口发送数据
//【返   回  值】 None
//=================================================================================================	
...
//=================================================================================================
//【名       称】 USART3_Send(unsigned char *DataToSend ,u8 data_num)
//【参       数】 
//【功       能】 串口发送数据
//【返   回  值】 None
//=================================================================================================	
...
//=================================================================================================
//【名       称】 UART4_Send(unsigned char *DataToSend ,u8 data_num)
//【参       数】 
//【功       能】 串口发送数据
//【返   回  值】 None
//=================================================================================================	
...
//=================================================================================================
//【名       称】 UART5_Send(unsigned char *DataToSend ,u8 data_num)
//【参       数】 
//【功       能】 串口发送数据
//【返   回  值】 None
//=================================================================================================	
