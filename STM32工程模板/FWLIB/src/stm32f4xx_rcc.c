...
/**
  ...
  * @retval None
  */
void RCC_AHB1PeriphClockCmd(uint32_t RCC_AHB1Periph, FunctionalState NewState)//GPIOx时钟使能函数
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState)//串口时钟使能函数
{
  /* Check the parameters */
