...
{         
    ...
    {       
        ...
        if(y>LCD_H-16){y=x=0;LCD_Clear(color);}
...
void Show_MMP() //显示图片
{
	...
	LCD_Address_Set(19,57,19+201,179+57);		//坐标设置
	for(int i=0;i<202*179;i++)
	 {	/**----------------------!!自己改gImage----------------------------**/
//		picL=*(gImage_mmp+i*2);	//数据低位在前,你要显示的图片
//		picH=*(gImage_mmp+i*2+1);				
